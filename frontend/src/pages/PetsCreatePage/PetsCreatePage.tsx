      ...
      <div className="content">
        ...
        <form>
          <div className="input-shell">
            ...
            <input type="text" id="animal-name" name="animal-name" placeholder="Введіть ім'я тварини"/>
          </div>

          <div className="input-shell">
            <label htmlFor="animal-breed">Порода Тварини</label>
            <input type="text" id="animal-breed" name="animal-breed" placeholder="Введіть породу тварини"/>
          </div>

          <div className="input-shell">
            <label htmlFor="animal-age">Вік Тварини</label>
            <input type="number" id="animal-age" name="animal-age" placeholder="Введіть вік тварини"/>
          </div>

          <div className="input-shell">
            <label htmlFor="animal-age">Стать тварини</label>
            <input type="number" id="animal-sex" name="animal-age" placeholder="Введіть стать тварини"/>
          </div>
