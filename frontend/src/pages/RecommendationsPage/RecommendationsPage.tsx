    ...
    <>
      ...
      <div className="main">
        ...
        <div className="recommendation-card">
          ...
          <p>Рекомендація: Вакцинуйте проти сказу, рекомендується проводити вакцинацію кожні 3 роки.</p>
          <p>Статус здоров'я: Очікується вакцинація</p>
        </div>

        <div className="recommendation-card">
          <h3>Жорік (Папуга, Хвилястий)</h3>
          <p>Рекомендація: Регулярно додавайте вітаміни до раціону, особливо в зимовий період.</p>
          <p>Статус здоров'я: Здоровий</p>
        </div>
      </div>
